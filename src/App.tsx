...
const Hero = () => {
  const { t } = useLanguage();
  return (
    <section className="relative pt-32 pb-20 px-6 overflow-hidden bg-[#070707]">
      
      {/* background glow (сделали мягче и дороже) */}
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          {/* badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-white/70 text-xs font-bold uppercase tracking-wider mb-6">
            <Clock className="w-3 h-3 text-purple-400" /> {t.hero.badge}
          </div>

          {/* title */}
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold leading-tight mb-6 break-words tracking-tight">
        ...
        >
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative z-10 overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.4)]">
